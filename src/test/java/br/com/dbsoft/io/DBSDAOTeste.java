...
//	}
	...
	public void getBigQuery(){
		try {
			System.out.println("Inicio: " + getMethodName() + " ==================================");
			DBSDAO<DBSDAOTesteModel> xDAO = new DBSDAO<DBSDAOTesteModel>(DBSDAOTesteModel.class, wCn);
			...
			xDAO.open(xSQL);
			List<DBSDAOTesteModel> xL = new ArrayList<DBSDAOTesteModel>();
			xL = xDAO.getListDataModel();
...
//			}
	...
	public void insertLoopDataModel(){
		try {
			...
			DBSDAO<DBSDAOTesteModel> xDAO = new DBSDAO<DBSDAOTesteModel>(DBSDAOTesteModel.class, wCn, "CRUD");
			Assert.assertEquals(0, xDAO.getRowsCount());
			for (int xX=1; xX < 6; xX++){
	...
	public void getDadoDataModel(){
		try {
			System.out.println("Inicio: " + getMethodName() + " ==================================");
			DBSDAOTesteModel xDT = new DBSDAOTesteModel();
			xDT = DBSIO.getDadoDataModel(DBSDAOTesteModel.class, wCn, "Select * From CRUD where Crud_ID=2");
